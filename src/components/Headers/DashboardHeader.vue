				...
				<a-col :span="24" :md="18" class="header-control">
					...
					<a-dropdown>
						<template #overlay>
							<a-menu>
							<a-menu-item key="1">
									<a style="display: flex; align-items: center;" href="/#/profile">
										<svg style="margin-right: 0.5rem;" width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
											<path d="M17.982 18.725A7.488 7.488 0 0 0 12 15.75a7.488 7.488 0 0 0-5.982 2.975m11.963 0a9 9 0 1 0-11.963 0m11.963 0A8.966 8.966 0 0 1 12 21a8.966 8.966 0 0 1-5.982-2.275M15 9.75a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
										</svg>
										Profile
									</a>
							</a-menu-item>
							<a-menu-item style="display: flex; align-items: center;" key="2">
							...
							<a-menu-item key="3">
								<a href="/#/sign-in" style="display: flex; align-items: center;">
									<svg style="margin-right: 0.4rem;" width="20" height="20" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
						...
						<a-button type="link" class="btn-sign-in">
							<svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<script>
	...
	const notificationsData = [
		{
			title: "Good work on 'Teaching Term 20232'!",
			img: 'images/logos/hust-logo.png',
			time: '13 minutes ago',
		},
		{
			title: "Your point on 'Family' is below average",
